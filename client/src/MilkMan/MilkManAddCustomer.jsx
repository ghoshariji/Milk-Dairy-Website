    ...
    <>
      ...
      <div className="flex flex-grow items-center justify-center px-4 py-10">
        ...
        >
            ...
            {fields.map((field, index) => (
              ...
              >
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl border-2 border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#40A1CB] transition"
                />
              </motion.div>
            ))}
          </motion.div>
          ...
          {/* Save Button */}
          <motion.button
            className="w-full bg-[#40A1CB] text-white text-lg font-semibold py-3 rounded-xl hover:bg-[#3185a7] transition-all duration-300 mt-4"
