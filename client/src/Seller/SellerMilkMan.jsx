...
import { Mail, User, IndianRupee, MapPin, BadgeInfo, Phone } from "lucide-react";
import API from "../api";
...
const infoItems = [
  ...
  {
    icon: <Phone className="text-[#40A1CB]" size={28} />,
    label: "Phone",
    key: "phone",
  },
];
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen bg-gray-100">
      ...
      <div className="flex-1 flex items-center justify-center p-4 mt-6 lg:mt-20 overflow-auto">
        ...
        >
          <h2 className="text-2xl sm:text-4xl font-bold text-center text-[#40A1CB] mb-6 sm:mb-8">
            Your Milkman
          </h2>
